...
class DoobieConfigSpec extends AnyFlatSpec with Matchers {
  ...
  "DoobieConfig" should "succeed to read a valid configuration" in {
    val config1: Config = ConfigFactory.parseString("""|doobie {
                                                       |  numThreads = 20
  ...
  it should "fail to read an invalid configuration" in {
    ...
    val config2: Config = ConfigFactory.parseString("""|doobie {
                                                       |  numThreads = 20
                                                       |  driverClassName = ""
                                                       |  url = "url"
                                                       |  user = "user"
    ...
    val config3: Config = ConfigFactory.parseString("""|doobie {
                                                       |  numThreads = 20
                                                       |  driverClassName = "driver"
                                                       |  url = ""
                                                       |  user = "user"
    ...
    val config4: Config = ConfigFactory.parseString("""|doobie {
                                                       |  numThreads = 20
                                                       |  driverClassName = "driver"
                                                       |  url = "url"
                                                       |  user = ""
